...
%\usepackage{packages/algebra}
%\usepackage{packages/singtheo}
%\usepackage{packages/nicetikz}
%\usepackage{packages/fonts}
%\usepackage{packages/tables}
...
\addpart{Deformations of Smooth Mappings}
%\input{chapters/deformations/introduction}
\pagelayout{margin} % Restore margins


\pagelayout{wide} % No margins
\addpart{Arnol'd-Ishikawa Theory of Legendrian Stability}
%\input{chapters/legendrian/introduction}
\pagelayout{margin} % Restore margins

%\input{chapters/legendrian/immersions}
%\input{chapters/legendrian/stability}

\pagelayout{wide} % No margins
\addpart{Deformations of Corank $1$ Frontals}
\pagelayout{margin} % Restore margins

%\input{chapters/deformations/mather_gaffney}

\pagelayout{wide} % No margins
\addpart{Singularities of Frontals Surfaces}
\pagelayout{margin} % Restore margins

%\input{chapters/surfaces/double_pts}
%\input{chapters/surfaces/homology}
